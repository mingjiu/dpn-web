...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and DPN pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and DPN pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from DPN pool', data)
  }
